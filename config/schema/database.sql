...
CREATE TABLE IF NOT EXISTS `users` (
    ...
    `default_picture` INT UNSIGNED NOT NULL DEFAULT 0,
...
-- Table `users_genders`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `genders_users`;

CREATE TABLE IF NOT EXISTS `genders_users` (
    `users_id`   INT UNSIGNED NOT NULL,
    `genders_id` INT UNSIGNED NOT NULL,
    PRIMARY KEY (`users_id`, `genders_id`),
    INDEX `fk_users_has_genders_genders1_idx` (`genders_id` ASC),
    INDEX `fk_users_has_genders_users1_idx` (`users_id` ASC),
